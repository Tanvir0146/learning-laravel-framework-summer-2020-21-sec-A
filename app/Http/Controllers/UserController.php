...
//         return [
//             ['id'=>1, 'username'=>'bbbb', 'password'=>'123', 'email'=>'email@aiub.edu', 'type'=>'admin'],
//             ['id'=>2, 'username'=>'uuuu', 'password'=>'223', 'email'=>'xyz@aiub.edu', 'type'=>'admin'],
//             ['id'=>3, 'username'=>'ssss', 'password'=>'124453', 'email'=>'abc@aiub.edu', 'type'=>'admin'],
//         ];
//     }
// }
public function create(){
...
public function getUserList(){
    return [
        ...
        ['id'=>2, 'username'=>'hassan', 'password'=>'223', 'email'=>'hassan@aiub.edu', 'type'=>'user'],
        ['id'=>3, 'username'=>'abc', 'password'=>'1234', 'email'=>'abc@aiub.edu', 'type'=>'admin'],
    ];
}
}
